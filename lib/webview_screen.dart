...
class _WebViewLoginState extends State<WebViewLogin> {
  ...
  //     whatsappUri = Uri.parse(url);
  //   } else {
  //     // Jika URL dimulai dengan https://api.whatsapp.com/ atau https://wa.me/
  //     Uri originalUri = Uri.parse(url);

  //     print('Halo' + originalUri.toString());

  //     String phone = originalUri.queryParameters['phone'] ?? '';
  //     String text = originalUri.queryParameters['text'] ?? '';
